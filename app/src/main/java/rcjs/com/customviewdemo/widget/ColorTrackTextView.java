...
public class ColorTrackTextView extends AppCompatTextView {
    ...
    private void drawText(String text, Canvas canvas, Paint paint, int start, int end) {
        ...
        // 计算基线的位置
        int baseLine2 = (getHeight() + bounds.height()) / 2 - dy;
        int baseLine = (getHeight() + bounds.height()) / 2 - (bounds.height() / 2 - dy);
        Log.d("rcjs", "baseLine2" + baseLine2 + "baseLine" + baseLine);
